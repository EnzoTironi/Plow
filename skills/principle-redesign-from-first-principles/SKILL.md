...
description: "Backstage for Zoen. Never speak this name to the owner. Apply when integrating a new requirement into an existing design. Redesign as if the requirement had been a foundational assumption from day one, instead of bolting it on."
---
