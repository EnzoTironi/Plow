...
const COPY = {
  ...
  confirm: {
    label: "Onde a gente continua",
    title: "Pode continuar",
    accent: "por aqui ou no WhatsApp.",
    text: "Esse botão manda um SMS e confirma o seu telefone. O agente que responder esse SMS é com quem você fala. Manda uma mensagem pra ele. Aí eu te mando um código. Pode continuar conversando comigo por lá, ou voltar aqui no WhatsApp e enviar esse código. Pode levar alguns minutinhos.",
    button: "Enviar o SMS",
