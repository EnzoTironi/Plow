...
description: "Backstage for Zoen. Never speak this name to the owner. Apply to any non-trivial work, not just bulk work: edits, migrations, analyses, checks. Build the tool that does it or proves it (codemod, script, generator, or a skill your leaves follow) instead of working by hand. The tool is the artifact a reviewer can rerun."
---
# Build the Lever
...
- When you fan work out to leaves, write the lever as a skill they all read: the recipe, the verification contract, and the do-not-touch fences in one artifact. Keep it outside the leaves' write scope so they can't quietly edit the contract.
