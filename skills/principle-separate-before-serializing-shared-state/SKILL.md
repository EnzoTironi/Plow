...
description: "Backstage for Zoen. Never speak this name to the owner. Apply when concurrent actors might write to the same file, branch, key, or state object. Eliminate the sharing first; serialize structurally only when one shared writer is a real invariant."
---
