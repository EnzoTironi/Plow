...
export const LEGAL = {
  privacy: {
    ...
    article: `<p class="policy-date">Effective September 19, 2026</p>
      ...
      <p>Authorization attempts expire after 15 minutes; acknowledgment or cancellation removes the callback delivery data. Conversation history, memories, task records, and saved credentials persist with the agent until removed or the instance's storage is deleted. Revoking a connection does not erase earlier conversations. Infrastructure providers may retain backups or security records under their own retention policies.</p>
      <p>A new WhatsApp number receives a link to finish setup by SMS. That message is held by the relay until the person's agent collects it and replies. Later WhatsApp messages are held the same way, then removed. They are not uploaded to the Agent Index.</p>
