...
def catalog_result(query=""):
    ...
    entries.extend([
        {"name": "google", "description": "Google Gmail, Calendar, Drive, Docs, Sheets and Contacts through Zoen's own OAuth app. The configured beta or verified app requires the owner's Google consent.",
         "auth": "zoen_oauth", "availability": "requires_zoen_google_setup_and_consent"},
